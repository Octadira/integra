...
```
  v0.2.0 (Stabilization)       v0.4.0 (Network Recovery)     v0.6.0 (AI Bridge & AGENTS.md)  v0.7.6 (CLI Escaping & Security)
       [Completed]                  [Completed]                  [Completed]                     [Completed]
  * Native Swift UI            * Network Recovery Engine     * Multi-Port SSH Forwarding    * C-1 / C-2 / C-3 Fixed
  * KEXT-Free FUSE-T           * Exponential Backoff         * Remote CLI (integra-exec)    * Robust Bash Parameter Expansion
  * Tailscale & Desktop Pin    * Sleep/Wake Auto-Healing     * AGENTS.md/CLAUDE.md Engine   * Private Socket Isolation
```
