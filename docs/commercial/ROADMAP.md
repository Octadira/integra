...
```
  v0.2.0 (Stabilization)       v0.4.0 (Network Recovery)     v0.6.0 (AI Bridge & AGENTS.md)  v0.8.0 (Remote Directory Picker)
       [Completed]                  [Completed]                  [Completed]                     [Completed]
  * Native Swift UI            * Network Recovery Engine     * Multi-Port SSH Forwarding    * Visual Remote Directory Browser
  * KEXT-Free FUSE-T           * Exponential Backoff         * Remote CLI (integra-exec)    * Lazy-Loading Path Navigator
  * Tailscale & Desktop Pin    * Sleep/Wake Auto-Healing     * AGENTS.md/CLAUDE.md Engine   * Quick Jump & Filter Toolbar
```
